...
func notifyStatusChangedInvk(_ context.Context, _ instrumentation.InvokeExecutorArgs) {
	log.Println("Notify admission changed")
}

func logTransitionInvk(_ context.Context, args instrumentation.InvokeExecutorArgs) {

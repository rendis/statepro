...
// ConditionModel is the json representation of a condition.
type ConditionModel struct {
	// Src is the name of the condition to be executed.
	// Validations:
	// * required
	// * no white space
	...
	// Args is the map of arguments to be passed to the condition.
	// Validations:
	// * optional
	// * keys:
	//	- no white space
	...
	// Description is the description of the condition.
	// Validations:
	// * optional
	...
	// Metadata is the map of metadata to be passed to the condition.
	// Validations:
	// * optional

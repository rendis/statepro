...
//	if approvedTransition, err := u.processEventOnAlways(ctx, evt); approvedTransition || err != nil {
//		return err
//	}
//
...
//}
//
//func (u *ExUniverse) processEventOnAlways(ctx context.Context, evt Event) (bool, error) {
//	realityModel := u.model.GetReality(*u.currentReality)
//
...
//		return true, u.processApprovedTransition(ctx, approvedTransition, evt)
//	}
//
//	return false, nil
//}
...
//		refT, parts, err := processReference(approvedTransition.Targets[0])
//		if err != nil {
...
//		if err != nil {
//			return nil, errors.Join(fmt.Errorf("error executing always transition condition '%s' in universe '%s'", transition.Condition.Src, u.id), err)
//		}
//
//		if doTransition {
